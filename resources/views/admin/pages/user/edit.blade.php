    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.users.update', $item->id) }}" method="post" class="needs-validation"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label>Konfirmasi Password <span class="text-gray">(Kosongkan jik tidak ingin merubah
                                        password)</span></label>
                                <input type="password"
                        ...
                        <div class="form-group">
                            ...
                            <select name="status" id="status" class="form-control" required="">
                                ...
                                <option @if ($item->status == 0 ?? old('status') == 0) selected @endif value="0">Tidak Aktif
                                </option>
                            </select>
                            @error('status')
                                <div class="invalid-feedback">
