    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <h5>Data Surat</h5>
                <a href="{{ route('admin.surat.create') }}" class="btn btn-sm btn-primary mb-3">Tambah Data</a>
            </div>
            <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="" method="post"
                                        ...
                                        @csrf
                                        @method('delete')
                                        <button data-action="{{ route('admin.surat.destroy',$item->id) }}" class="btn btn-sm btn-danger btnDelete"><i
