    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                ...
                <a href="{{ route('admin.surat-keluar.create') }}" class="btn btn-sm btn-primary mb-3">Tambah Data</a>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        @foreach ($items as $item)
                            <tr>
                                ...
                                <td>
                                    @if ($item->file)
                                        <a href="{{ route('admin.surat-keluar.download',$item->kode) }}" target="_blank" class="btn btn-success btn-sm">Download</a>
                                    @else
                                ...
                                <td>
                                    ...
                                    <form action="" method="post"
                                        ...
                                        @csrf
                                        @method('delete')
                                        <button data-action="{{ route('admin.surat-keluar.destroy',$item->id) }}" class="btn btn-sm btn-danger btnDelete"><i
